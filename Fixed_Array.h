 ...
 * @class Fixed_Array
 *
 * Implementation of a fixed size Array_Base, i.e., one that is not
...
public:
  ...
  Fixed_Array (void);
	 ...
	 * Copy constructor.
	 *
	 * @param[in]      arr        Source Array_Base
	 */
  Fixed_Array (const Fixed_Array <T, N> & arr);
	
  /**
   * Initializing constructor. The source Array_Base can be of any size
   ...
   * Array_Base with the specified \a fill value.
   *
